      ...
      <div className="flex shrink-0 items-center gap-2">
        {onOpenAiEdit && (
          <button
            ...
            title="AI Assistant"
            className="flex h-7 cursor-pointer items-center gap-1.5 rounded-md border border-violet-500/25 bg-violet-500/10 px-2 text-[11px] text-violet-300 transition-colors hover:bg-violet-500/20"
          >
